...
const debug = false, path = require('path'), fs = require('fs'), Events = require('events'), Countries = require('../countries')
...
class Language extends Events {
    ...
    async getCountries(locales){ // return countries which speaks these languages
        if(!locales){
